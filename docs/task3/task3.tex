...
\begin{center}
  ...
  {\large Project 3 --- Task 3 Deliverable}\\[0.4em]
...
\begin{center}
  {\normalsize\textit{This document outlines five architectural tactics and two design patterns employed in the WanderMate system, explaining how each addresses specific non-functional requirements and contributes to the overall quality attributes of the architecture.}}
\end{center}
