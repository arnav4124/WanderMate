...
\begin{center}
  ...
  {\large Project 3 --- Task 2 Deliverable}\\[0.4em]
...
\begin{center}
  {\normalsize\textit{This document identifies stakeholders, their concerns, and the architectural viewpoints and views that address those concerns (per IEEE 42010), and documents four major architecture decision records following the Nygard ADR template.}}
\end{center}
